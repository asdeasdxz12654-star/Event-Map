...
const PATHS = {
  ...
  // 부스·상점. 요약 안내판의 "참가 부스" 칸에 쓴다.
  store: (
    <>
      <path d="M4.5 10.5V19a1.5 1.5 0 0 0 1.5 1.5h12a1.5 1.5 0 0 0 1.5-1.5v-8.5" />
      <path d="M3 5h18l-1.2 4.4a2.6 2.6 0 0 1-5 .3 2.6 2.6 0 0 1-5.6 0 2.6 2.6 0 0 1-5 -.3Z" />
    </>
  ),
  image: (
    <>
