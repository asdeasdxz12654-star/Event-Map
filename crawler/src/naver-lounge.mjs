...
const LOUNGES = [
  {
    ...
    loungeId: 'ZZZ',
    keywords: ['호요랜드', '콜라보', '팝업스토어', '축제', '콘서트', '음악회', '공연', '굿즈', '오프라인', '주년'],
  },
  {
    name: '승리의 여신: 니케',
    userId: '6cd045bd8eedfccc068bd0e70a81ea26',
    loungeId: 'NIKKE_The_Goddess_of_Victory',
    keywords: ['콜라보', '콘서트', '음악회', '무대', '공연', '오프라인', '팝업스토어', '굿즈', '현장', '주년'],
  },
  {
    name: '명조',
    userId: '682d60022b932fdd0264e843596ba233',
    loungeId: 'WutheringWaves',
    keywords: ['콜라보', '띵조 페스티벌', '월드 투어', '띵조카니발', '띵조파크', '띵조마켓', '굿즈', '띵조월드', '띵조', '콘서트', '음악회', '공연', '주년'],
  },
  {
    name: '이환',
    userId: '75e5b10204562ac8c168240d3a5546cf',
    loungeId: 'NTE',
    keywords: ['콜라보', '굿즈', '오프라인', '공연', '콘서트', '음악회', '팝업스토어', '주년'],
  },
]
